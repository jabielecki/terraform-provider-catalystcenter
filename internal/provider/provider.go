...
func (p *CcProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewDeviceResource,
		NewDeviceFamiliesResource,
		NewDeviceRoleResource,
		NewDiscoveryResource,
		NewFloorResource,
		NewImageDistributionResource,
		NewImageFromFileResource,
		NewImageFromUrlResource,
		NewIPPoolResource,
...
func (p *CcProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewDeviceFamiliesDataSource,
		NewDiscoveryDataSource,
		NewFloorDataSource,
		NewImageDistributionDataSource,
		NewImageFromFileDataSource,
		NewImageFromUrlDataSource,
		NewIPPoolDataSource,
