...
func (data ImageFromFile) getPath() string {
...
func (data ImageFromFile) toBody(ctx context.Context, state ImageFromFile) string {
	body := ""
...
func (data *ImageFromFile) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ImageFromFile) updateFromBody(ctx context.Context, res gjson.Result) {
