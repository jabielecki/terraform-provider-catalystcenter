...
description: |-
  This resource can distribute (copy) a software image file to the chosen network device.  This provider currently cannot undistribute images once created, so beware of creating many unnecessary images.
---

# catalystcenter_image_distribution (Resource)

This resource can distribute (copy) a software image file to the chosen network device. <p/> This provider currently cannot undistribute images once created, so beware of creating many unnecessary images.
